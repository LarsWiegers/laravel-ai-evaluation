...
features:
  ...
  - title: Artisan eval runner
    details: Run eval files via `php artisan ai-evals:run`.
    link: /running-standalone
  - title: Report ready
    details: Produce text, JSON, JUnit, or GitHub Actions reports from one runner.
    link: /output-formats
  - title: CI ready
...
For JSON, JUnit, and GitHub annotation reports, see [Output formats](/output-formats).
